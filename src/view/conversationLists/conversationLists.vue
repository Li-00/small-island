<template>
    <div class="dialogue">
        ...
        <el-card class="dialogue-content">
            ...
            <div class="dialogue-content-query">
                <el-form :inline="true" :model="state.dialogueQuery" class="demo-form-inline">
                    <el-form-item label="对话编号">
                        <el-input
                            v-model="state.dialogueQuery.code"
                            placeholder="请输入编号"
                            clearable
                        />
                    </el-form-item>
                    <el-form-item label="对话名称">
                        <el-input
                            v-model="state.dialogueQuery.name"
                            placeholder="请输入对话名称"
                            clearable
                        />
                    </el-form-item>
                    <el-form-item label="对话类型">
                        ...
                        >
                            <el-option
                                v-for="typeItem in state.dialogueQueryType"
                                :key="typeItem.value"
                    ...
                    <el-form-item>
                        ...
                        <el-button @click="onSubmit">
                            <i class="icons iconfont icon-zhongzhi"></i>
                            重置
                        </el-button>
                    </el-form-item>
                </el-form>
            ...
            <div class="other-btn">
                <el-button>
                    <i class="icons iconfont icon-xiazai"></i>
                    下载
                </el-button>
            </div>
